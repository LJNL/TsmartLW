                      ...
                      if (c == '#')
                        {
                          ...
                          do
                            c = getc_unlocked (fp);
                          while (!(c == 
# 211 "localcharset.c" 3 4
                                       (-1) 
# 211 "localcharset.c"
                                           || c == '\n'));
                          if (c == 
# 212 "localcharset.c" 3 4
                                  (-1)
# 212 "localcharset.c"
                                     )
                            break;
...
locale_charset (void)
{
  ...
  codeset = nl_langinfo (
# 403 "localcharset.c" 3 4
                        CODESET
# 403 "localcharset.c"
                               );
# 584 "localcharset.c"
  if (codeset == 
# 584 "localcharset.c" 3 4
                ((void *)0)
# 584 "localcharset.c"
                    )
