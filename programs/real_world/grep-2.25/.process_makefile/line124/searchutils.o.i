...
# 32 "searchutils.c"
  ...
  if (match_icase && 
# 35 "searchutils.c" 3 4
                    (__ctype_get_mb_cur_max ()) 
# 35 "searchutils.c"
                               == 1)
    {
      for (i = 0; i < (
# 37 "searchutils.c" 3 4
                     (0x7f * 2 + 1) 
# 37 "searchutils.c"
                     + 1); ++i)
        trans[i] = toupper (i);
...
# 125 "searchutils.c" 3
                           rpl_mbrtowc 
# 125 "searchutils.c"
                                   (&wc, cur, end - cur, &mbs) < (size_t) -2
          ? wc : 
# 126 "searchutils.c" 3 4
                (0xffffffffu)
# 126 "searchutils.c"
                    );
}
