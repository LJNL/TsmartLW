...
# 124 "propername.c" 3 4
             _Bool 
# 124 "propername.c"
                  word_boundary_before;
              const char *p;
              
# 126 "propername.c" 3 4
             _Bool 
# 126 "propername.c"
                  word_boundary_after;

              word_boundary_before = 
# 128 "propername.c" 3 4
                                    1
# 128 "propername.c"
                                        ;
              if (string < tsub_in_string)
                if (
# 130 "propername.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 130 "propername.c"
...
# 131 "propername.c"
              ...
              word_boundary_after = 
# 134 "propername.c" 3 4
                                   1
# 134 "propername.c"
                                       ;
              if (*p != '\0')
                if (
# 136 "propername.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 136 "propername.c"
                   (unsigned char) *p
# 136 "propername.c" 3 4
...
# 230 "propername.c"
  ...
  name = (name_converted != 
# 248 "propername.c" 3 4
                           ((void *)0) 
# 248 "propername.c"
                                ? name_converted :
          name_converted_translit != 
# 249 "propername.c" 3 4
                                    ((void *)0) 
# 249 "propername.c"
                                         ? name_converted_translit :
          name_ascii);
...
# 266 "propername.c"
      ...
      else
        {
          ...
          if (alloc_name_converted != 
# 278 "propername.c" 3 4
                                     ((void *)0)
# 278 "propername.c"
                                         )
            free (alloc_name_converted);
          if (alloc_name_converted_translit != 
# 280 "propername.c" 3 4
                                              ((void *)0)
# 280 "propername.c"
                                                  )
            free (alloc_name_converted_translit);
    ...
    {
      if (alloc_name_converted != 
# 287 "propername.c" 3 4
                                 ((void *)0) 
# 287 "propername.c"
                                      && alloc_name_converted != name)
        free (alloc_name_converted);
      if (alloc_name_converted_translit != 
# 289 "propername.c" 3 4
                                          ((void *)0)
