...
# 49 "opendir-safer.c"
          ...
          if (f < 0)
            {
              e = 
# 55 "opendir-safer.c" 3 4
                 (*__errno_location ())
# 55 "opendir-safer.c"
                      ;
              newdp = 
# 56 "opendir-safer.c" 3 4
                     ((void *)0)
# 56 "opendir-safer.c"
                         ;
            }
