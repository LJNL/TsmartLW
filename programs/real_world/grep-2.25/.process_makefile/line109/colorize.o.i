...
# 1 "<command-line>" 2
# 1 "colorize.c"
# 1 "./colorize-posix.c" 1
# 22 "./colorize-posix.c"
#pragma GCC diagnostic ignored "-Wsuggest-attribute=const"


# 1 "../config.h" 1
# 26 "./colorize-posix.c" 2
