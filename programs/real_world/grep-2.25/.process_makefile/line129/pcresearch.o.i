...
# 32 "grep.h" 3 4
      _Bool 
# 32 "grep.h"
           buf_has_encoding_errors (char *, size_t);
# 33 "search.h" 2
# 1 "dfa.h" 1
# 23 "dfa.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h" 1 3 4
...
# 61 "pcresearch.c"
         && 0 < jit_stack_size && jit_stack_size <= 0x7fffffff / 2)
        {
...
Pcompile (char const *pattern, size_t size)
{
  ...
  int fix_len_max = 
# 105 "pcresearch.c" 3 4
                   (((
# 105 "pcresearch.c"
                   sizeof wprefix - 1 + sizeof wsuffix - 1
# 105 "pcresearch.c" 3 4
                   )>(
# 105 "pcresearch.c"
...
# 106 "pcresearch.c"
  ...
  int flags = (
# 108 "pcresearch.c" 3 4
              0x00000002
               
# 109 "pcresearch.c"
              | (match_icase ? 
# 109 "pcresearch.c" 3 4
                               0x00000001 
# 109 "pcresearch.c"
                                             : 0));
...
# 115 "pcresearch.c"
                   )
    {
      ...
      multibyte_locale = 
# 120 "pcresearch.c" 3 4
                        1
# 120 "pcresearch.c"
                            ;
      flags |= 
# 121 "pcresearch.c" 3 4
              0x00000800
# 121 "pcresearch.c"
                       ;
    }
  ...
  if (memchr (pattern, '\n', size))
    error (EXIT_TROUBLE, 0, gettext("the -P option only supports a single pattern"));
  if (! eolbyte)
    {
      
# 129 "pcresearch.c" 3 4
     _Bool 
# 129 "pcresearch.c"
          escaped = 
# 129 "pcresearch.c" 3 4
...
# 130 "pcresearch.c" 3 4
     _Bool 
# 130 "pcresearch.c"
          after_unescaped_left_bracket = 
# 130 "pcresearch.c" 3 4
                                         0
# 130 "pcresearch.c"
                                              ;
      for (p = pattern; *p; p++)
        if (escaped)
          escaped = after_unescaped_left_bracket = 
# 133 "pcresearch.c" 3 4
                                                  0
# 133 "pcresearch.c"
                                                       ;
        else
          {
            if (*p == '$' || (*p == '^' && !after_unescaped_left_bracket))
              error (EXIT_TROUBLE, 0,
                     gettext("unescaped ^ or $ not supported with -Pz"));
            escaped = *p == '\\';
  ...
  *n = '\0';
  ...
  extra = pcre_study (cre, 
# 178 "pcresearch.c" 3 4
                          0x0001
# 178 "pcresearch.c"
                                                , &ep);
  if (ep)
  ...
  if (pcre_fullinfo (cre, extra, 
# 183 "pcresearch.c" 3 4
                                16
# 183 "pcresearch.c"
                                             , &e))
    error (EXIT_TROUBLE, 0, gettext("internal error (should never happen)"));
  ...
  int sub[NSUB];
  empty_match[
# 194 "pcresearch.c" 3 4
             0
# 194 "pcresearch.c"
                  ] = pcre_exec (cre, extra, "", 0, 0,
                                  
# 195 "pcresearch.c" 3 4
                                 0x00000080
# 195 "pcresearch.c"
                                            , sub, NSUB);
  empty_match[
# 196 "pcresearch.c" 3 4
             1
# 196 "pcresearch.c"
                 ] = pcre_exec (cre, extra, "", 0, 0, 0, sub, NSUB);
...
# 211 "pcresearch.c" 3 4
 _Bool 
# 211 "pcresearch.c"
      bol = p[-1] == eolbyte;
  char const *line_start = buf;
  int e = 
# 213 "pcresearch.c" 3 4
         (-1)
# 213 "pcresearch.c"
                           ;
  char const *line_end;
...
# 234 "pcresearch.c"
      ...
      if (multiline)
        {
          size_t pcre_size_max = 
# 238 "pcresearch.c" 3 4
                                (((0x7fffffff)<((18446744073709551615UL) 
# 238 "pcresearch.c"
                                - 1
# 238 "pcresearch.c" 3 4
                                ))?(0x7fffffff):((18446744073709551615UL) 
...
# 239 "pcresearch.c"
      ...
      else
        {
          ...
          too_big = 0x7fffffff < line_end - p;
        }

      if (too_big)
        error (EXIT_TROUBLE, 0, gettext("exceeded PCRE's line length limit"));
...
# 261 "pcresearch.c"
          ...
          if (!bol)
            options |= 
# 277 "pcresearch.c" 3 4
                      0x00000080
# 277 "pcresearch.c"
                                 ;
          if (multiline)
            options |= 
# 279 "pcresearch.c" 3 4
                      0x00002000
# 279 "pcresearch.c"
                                        ;
...
# 321 "pcresearch.c"
      ...
      if (e != 
# 327 "pcresearch.c" 3 4
              (-1)
# 327 "pcresearch.c"
                                )
        break;
      bol = 
# 329 "pcresearch.c" 3 4
           1
# 329 "pcresearch.c"
               ;
    }
...
# 336 "pcresearch.c"
        ...
        case 
# 339 "pcresearch.c" 3 4
            (-6)
# 339 "pcresearch.c"
                               :
          error (EXIT_TROUBLE, 0, gettext("memory exhausted"));


        case 
# 343 "pcresearch.c" 3 4
            (-27)
# 343 "pcresearch.c"
                                     :
          error (EXIT_TROUBLE, 0, gettext("exhausted PCRE JIT stack"));


        case 
# 347 "pcresearch.c" 3 4
            (-8)
# 347 "pcresearch.c"
                                 :
          error (EXIT_TROUBLE, 0, gettext("exceeded PCRE's backtracking limit"));
        ...
        default:
          ...
          error (EXIT_TROUBLE, 0, gettext("internal PCRE error: %d"), e);
        }
