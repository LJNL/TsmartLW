    ...
    if (n_leading_slash == 2)
      {
        ...
        if (slash == 
# 143 "chdir-long.c" 3 4
                    ((void *)0)
# 143 "chdir-long.c"
                        )
          {
            
# 145 "chdir-long.c" 3 4
           (*__errno_location ()) 
# 145 "chdir-long.c"
                 = 
# 145 "chdir-long.c" 3 4
...
# 171 "chdir-long.c" 3 4
                                        4096
# 171 "chdir-long.c"
                                                );
        if (slash == 
# 172 "chdir-long.c" 3 4
                    ((void *)0)
# 172 "chdir-long.c"
                        )
          {
            
# 174 "chdir-long.c" 3 4
           (*__errno_location ()) 
# 174 "chdir-long.c"
                 = 
# 174 "chdir-long.c" 3 4
...
# 179 "chdir-long.c"
   ...
   Fail:
    {
      int saved_errno = 
# 202 "chdir-long.c" 3 4
                       (*__errno_location ())
# 202 "chdir-long.c"
                            ;
      cdb_free (&cdb);
      
# 204 "chdir-long.c" 3 4
     (*__errno_location ()) 
# 204 "chdir-long.c"
           = saved_errno;
      return -1;
